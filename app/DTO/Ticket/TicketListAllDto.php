...
#[TypeScript]
class TicketListAllDto implements FromModelInterface, FromCollectionInterface
{
    public function __construct(
        ...
        #[LiteralTypeScriptType('TicketLogDto[]')]
    ...
    public static function fromModel(Model $model): static
    {
        ...
        $ticketLogService = app(TicketLogService::class);
        ...
        return new self(
            ...
            available_statuses: $categoryStatuses
                ...
                ->all(),
            logs: TicketLogDto::fromCollection($ticketLogService->getLogsByTicketId($model->id)),
        );
    }
