...
const MultipleSelector = ({
    ...
    const commandFilter = React.useCallback(() => {
        ...
        return (value: string, search: string) => {
            ...
            const option = [...Object.values(options)].flat()
                    .find(opt => opt.value === value) ||
                selected.find(opt => opt.value === value);
            ...
            return -1; // Не соответствует поиску
        };
    }, [commandProps?.filter, options, selected]);
    ...
    return (
        ...
        >
            ...
            <div className="relative">
                <div
                    className={cn(
                        "border-input absolute z-50 w-full overflow-hidden rounded-md border bg-popover shadow-md",
                ...
                >
                    {open && (
                        <CommandList
                            className="text-popover-foreground max-h-[200px] overflow-auto"
                            onMouseLeave={() => {
